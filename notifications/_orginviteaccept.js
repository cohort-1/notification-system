 ...
 * @returns
 */
exports.sms = (data) => `Hello ${data?.orgName},\nGreat news! ${data?.name} has accepted your invitation to join ${data?.orgName}.\nIf you have any questions, feel free to contact us at (888) 899-7275.\nThanks,\nTruck Parking Club`;
/*  */
exports.subject = (data) => `${data?.name} Has Accepted Your Invitation`;
/**
 * email template for past due bookings
