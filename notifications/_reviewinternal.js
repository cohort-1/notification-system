/*  */
exports.subject = (data) => `Someone just gave ${data?.stars} stars for "${data?.listingTitle}"`;

/**
 * email template for past due bookings
 * @param {{ data: { name: String, orgName: String, link: URL}, footer: Element, assetsBaseUrl: URL}}
 * @returns
 */
exports.email = ({ data, assetsBaseUrl }) => `
                                    ...
                                    <header class="header" style="margin: 0; box-sizing: border-box; position: relative; width: 100%; padding: 36.5px 40px 36.5px 40px; text-align: center; justify-content: center;">                            
                                      <div style="display: table; width: 100%;">
                                        <div style="margin: 0; display: table-cell; text-align: center; width: 100%; color: #5573a0; font-size: 14px; font-family: Open Sans; font-weight: 400;">
                                          <img src="${assetsBaseUrl}/logo.png" height="100px" style="text-align: center; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; margin: 0; padding: 0; box-sizing: border-box; height='100px'" />
                                        </div>
                                      </div>
                                    </header>
                                    <main>
                                      <div style="margin: 0; box-sizing: border-box; position: relative; width: 100%; height: auto; background-color: white; z-index: 0; padding: 0px 40px 0px 40px;">
                                        <div class="content-container" style="box-sizing: border-box; width: 100%; margin: 0px auto 30px; padding: 12px 20px 32px 20px; border-radius: 20px; background-color: rgba(200,220,250,0.12); text-align: center;">
                                          <div class="content" style=" margin: 0; padding: 0; box-sizing: border-box;">
                                            <h4 style=" margin: 0; line-height: 29px; mso-line-height-rule: exactly; font-family: Open Sans; font-size: 24px; font-style: normal; font-weight: 700; color: #ffa459; margin: 0; padding: 0; box-sizing: border-box; letter-spacing: 0.41px; margin-bottom: 16px; margin-top: 25px; line-height: 1.6rem;">
                                              New rating
                                            </h4>
                                            <p style="margin: 0; -webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; font-family: Open Sans; line-height: 21px; color: #0b161d; font-size: 16px; margin: 0; padding: 0; box-sizing: border-box; margin-bottom: 15px; margin-top: 10px;">
                                              <h4 style="margin: 0; font-family: Open Sans; font-size: 16px; font-style: normal; font-weight: 500; color: #14283c; margin: 0; padding: 0; box-sizing: border-box; text-align: left; margin-bottom: 5px;">
                                                Listing title:
                                                <span style="color:#ffa459">${data?.listingTitle || '-'}</span>
                                              </h4>
                                              <h4 style="margin: 0; font-family: Open Sans; font-size: 16px; font-style: normal; font-weight: 500; color: #14283c; margin: 0; padding: 0; box-sizing: border-box; text-align: left; margin-bottom: 5px;">
                                                Reservation code:
                                                <span style="color:#ffa459">${data?.reservation_code || '-'}</span>
                                              </h4>
                                              <h4 style="margin: 0; font-family: Open Sans; font-size: 16px; font-style: normal; font-weight: 500; color: #14283c; margin: 0; padding: 0; box-sizing: border-box; text-align: left; margin-bottom: 5px;">
                                                Rating:
                                                <span style="color:#ffa459">${data?.stars || '-'} stars</span>
                                              </h4>
                                              <h4 style="margin: 0; font-family: Open Sans; font-size: 16px; font-style: normal; font-weight: 500; color: #14283c; margin: 0; padding: 0; box-sizing: border-box; text-align: left; margin-bottom: 5px;">
                                                Review:
                                                <span style="color:#ffa459">${data?.comment || '-'}</span>
                                              </h4>
                                            </p>
                                        </div>
                                      </div>
