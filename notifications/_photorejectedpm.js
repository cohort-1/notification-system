...
exports.subject = () => `Photo approval declined`;
                                      ...
                                      <div style="margin: 0;box-sizing: border-box;position: relative;width: 100%;height: auto;background-color: white;z-index: 0;padding: 0px 40px 0px 40px;">
                                        <div class="content-container" style="box-sizing: border-box;width: 100%;margin: 0px auto 30px;padding: 12px 20px 32px 20px;border-radius: 20px;background-color: rgba(200,220,250,0.12);text-align: center;">
                                          <div class="content" style="margin: 0;padding: 0;box-sizing: border-box;">
                                            <h4 style="margin: 0;line-height: 29px;mso-line-height-rule: exactly;font-family: Open Sans;font-size: 24px;font-style: normal;font-weight: 700;color: #ed2626;margin: 0;padding: 0;box-sizing: border-box;letter-spacing: 0.41px;margin-bottom: 16px;margin-top: 25px;line-height: 1.6rem;text-align: center;">
                                              Photo approval declined
                                            </h4>
                                            ...
                                            <p style="margin: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;mso-line-height-rule: exactly;font-family: Open Sans;line-height: 21px;color: #0b161d;font-size: 16px;margin: 0;padding: 0;box-sizing: border-box;margin-bottom: 15px;text-align: left;">
                                              We regret to inform you that photo for your listing "${data?.listng_name}" on the Truck Parking Club has been rejected.<br/><br />
                                              Reason: <span style="font-style: italic;">"${data?.reject_reason}"</span>.
                                            </p>
                                            <h4 style="margin: 0;padding: 0;box-sizing: border-box;font-family: Open Sans;font-size: 16px;font-weight: 600;text-align: left;margin-bottom: 15px;color: #0b161d;">
                                              Here is the image that was declined:
                                            </h4>
                                            <img height="200px" src="${data?.image}" alt="featured image" />
                                            <p style="margin: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;mso-line-height-rule: exactly;font-family: Open Sans;line-height: 21px;color: #0b161d;font-size: 16px;margin: 0;padding: 0;box-sizing: border-box;margin-bottom: 15px;text-align: left;">
                                              <br />If you have any questions or need assistance please don't hesitate to reach out to our dedicated support team at <a href="${ENV.UI_HOST_BASE_URL}/contact" style="text-decoration: none;">Contact Us</a> page or <a href="tel:8888997275" style="text-decoration: none;">(888) 899-7275</a>.
                                            </p>
                                            ...
                                            <p style="margin: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;mso-line-height-rule: exactly;font-family: Open Sans;line-height: 21px;color: #0b161d;font-size: 16px;margin: 0;padding: 0;box-sizing: border-box;margin-bottom: 0px;text-align: left;">
                                              Customer Care Team <br />TruckParkingClub.com
                                            </p>
                                          </div>
                                        </div>
                                      </div>
