const { formatPhoneNumber } = require('../utils/text');
/**
 * email template for past due bookings
 * @param {{paymentDeadline: Date, listingTitle: String, amount: Number}}
 * @returns
 */
exports.sms = (data) =>
	// eslint-disable-next-line no-undef
	`Dear ${data?.customerName},\n\nYour reservation subscription for ${data?.listingTitle} at TruckParkingClub.com, due on ${data?.endDate}, is overdue. Please ensure your payment is made to avoid possible suspension of your reservation. We will attempt to charge your card on file. If you want to make your payment now or you need to replenish funds on your card, please click the link below. Thank you.\n${process.env.UI_HOST_BASE_URL}/order/${data.booking_id}/details Customer Care Team\ninfo@TruckParkingClub.com\n(423) 777-6899.`;
/*  */
exports.subject = () => `Past due booking`;
/**
 * email template for past due bookings
 * @param {{ data: {paymentDeadline: Date, listingTitle: String, amount: Number}, footer: Element, assetsBaseUrl: URL}}
 * @returns
 */
                                        ...
                                        <div class="content-container" style="box-sizing: border-box;width: 100%;margin: 0px auto 30px;padding: 12px 20px 32px 20px;border-radius: 20px;background-color: rgba(200,220,250,0.12);">
                                          <div class="content" style="margin: 0;padding: 0;box-sizing: border-box;">
                                            ...
                                            <p style="margin: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;mso-line-height-rule: exactly;font-family: Open Sans;line-height: 21px;color: #0b161d;font-size: 16px;margin: 0;padding: 0;box-sizing: border-box;margin-bottom: 15px;margin-top: 10px;">
                                              We hope this message finds you well. We want to inform you that your reservation ${data?.reservationCode} subscription for ${data?.listingTitle} at TruckParkingClub.com, due on ${
	data?.endDate
}, is currently overdue. Our system will automatically attempt to charge your card on file.
                                              If you want to make your payment now or you need to replenish funds on your card, please click the link below.
                                            </p>
                                            <p style="margin: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;mso-line-height-rule: exactly;font-family: Open Sans;line-height: 21px;color: #0b161d;font-size: 16px;margin: 0;padding: 0;box-sizing: border-box;margin-bottom: 15px;margin-top: 10px;">
                                              ${
																								// eslint-disable-next-line no-undef
																								process.env.UI_HOST_BASE_URL
																							}/order/${data.booking_id}/details
                                            </p>
                                            <p style="margin: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;mso-line-height-rule: exactly;font-family: Open Sans;line-height: 21px;color: #0b161d;font-size: 16px;margin: 0;padding: 0;box-sizing: border-box;margin-bottom: 15px;margin-top: 10px;">
                                              To avoid disruption to your service, please ensure the payment of $${
																								data?.totalPrice / 100
																							} is received. Failure to do so may result in the permanent suspension of your reservation, and you will no longer have access to this location. Additionally, your vehicle may be subject to towing or booting.
                                            </p>
                                            <p style="margin: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;mso-line-height-rule: exactly;font-family: Open Sans;line-height: 21px;color: #0b161d;font-size: 16px;margin: 0;padding: 0;box-sizing: border-box;margin-bottom: 15px;margin-top: 10px;">
                                          ...
                                          <p style="margin: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;mso-line-height-rule: exactly;font-family: Open Sans;line-height: 21px;color: #0b161d;font-size: 16px;margin: 0;padding: 0;box-sizing: border-box;margin-bottom: 0px;text-align: left;">
                                            <a href="mailto:info@truckparkingclub.com">info@TruckParkingClub.com</a>
                                          </p>
                                          <p style="margin: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;mso-line-height-rule: exactly;font-family: Open Sans;line-height: 21px;color: #0b161d;font-size: 16px;margin: 0;padding: 0;box-sizing: border-box;margin-bottom: 0px;text-align: left;">
                                            <a href="tel:4237776899">+1${formatPhoneNumber('4237776899')}</a>.
                                            <br />
                                          </p>
                                        </div>
                                      </div>
