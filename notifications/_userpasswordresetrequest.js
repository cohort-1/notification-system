...
const UI_HOST_BASE_URL = process.env.UI_HOST_BASE_URL;
exports.subject = () => `Password reset email`;
                                      ...
                                      <div style="margin: 0;box-sizing: border-box;position: relative;width: 100%;height: auto;background-color: white;z-index: 0;padding: 0px 40px 0px 40px;">
                                        <div class="content-container" style="box-sizing: border-box;width: 100%;margin: 0px auto 30px;padding: 12px 20px 32px 20px;border-radius: 20px;background-color: rgba(200,220,250,0.12);">
                                          <div class="content" style="margin: 0;padding: 0;box-sizing: border-box;">
                                            <h4 style="margin: 0;line-height: 29px;mso-line-height-rule: exactly;font-family: Open Sans;font-size: 24px;font-style: normal;font-weight: 700;color: #2ecc71;margin: 0;padding: 0;box-sizing: border-box;letter-spacing: 0.41px;margin-bottom: 16px;margin-top: 25px;line-height: 1.6rem;text-align: center;">
                                              Password Reset
                                            </h4>
                                            <p style="margin: 0;-webkit-text-size-adjust: none;-ms-text-size-adjust: none;mso-line-height-rule: exactly;font-family: Open Sans;line-height: 21px;color: #0b161d;font-size: 16px;margin: 0;padding: 0;box-sizing: border-box;margin-bottom: 15px;margin-top: 10px;">
                                             Please click <a href='${UI_HOST_BASE_URL}/new-password?token=${data.token}'>here</a> to reset the password for Truck Parking Club</b><br /><br /><br />
                                             <small>or copy the following link into your browser ${UI_HOST_BASE_URL}/new-password?token=${data.token}</small>
                                            </p>
                                          </div>
