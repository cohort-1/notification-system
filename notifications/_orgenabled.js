 ...
 */
exports.sms = (data) =>
	`Hello ${data?.name},\nOrganization mode has been successfully enabled for your account. You can now invite additional users with your organization for ease of access across Truck Parking Club.\nIf you have any questions, feel free to contact us at (888) 899-7275.\nThanks,\nTruck Parking Club`;
/*  */
exports.subject = () => `Organization Mode Enabled for Your Account`;
/**
 * email template for past due bookings
